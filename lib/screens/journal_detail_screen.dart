...
class JournalDetailScreen extends StatelessWidget {
  ...
  // PERBAIKAN DI SINI: Constructor menerima Journal biasa
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: journal.imageUrl != null
                      ? Stack(
                          fit: StackFit.expand,
                          children: [
                            Hero(tag: 'journal-img-${journal.id}', child: Image.network(journal.imageUrl!, fit: BoxFit.cover, errorBuilder: (context, error, stackTrace) => Container(color: moodColor.withOpacity(0.2)))),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (journal.voiceUrl != null)
                        Padding(padding: const EdgeInsets.only(bottom: 24), child: JournalAudioPlayer(url: journal.voiceUrl!, isDark: isDark)),
